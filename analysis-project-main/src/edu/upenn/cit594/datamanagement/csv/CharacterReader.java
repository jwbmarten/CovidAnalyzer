...
/**
 * {@code util.CharacterReader} is a wrapper for normal {@code Reader} and
...
public class CharacterReader implements AutoCloseable {
     ...
     *
     * <p>Since {@code util.CharacterReader} implements {@code AutoCloseable}, this
     * method will be automatically invoked if the {@code util.CharacterReader}
